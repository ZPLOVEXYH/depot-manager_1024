/**
 * @filename:BRailwayLoadDelList 2019年08月20日
...
/**
 * @Description: 装车记录单作废报文表体运抵单信息
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月20日
 * @Version: V1.0
 */
@TableName("b_railway_load_del_list")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BRailwayLoadDelList extends Model<BRailwayLoadDelList> {
    ...
    @TableField(value = "railway_load_del_conta_id")
