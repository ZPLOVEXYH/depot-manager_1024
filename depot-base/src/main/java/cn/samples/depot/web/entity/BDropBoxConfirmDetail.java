/**
 * @filename:BDropBoxConfirmDetail 2019年08月01日
 ...
 * @Version: V1.0
 */
@TableName("b_drop_box_confirm_detail")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BDropBoxConfirmDetail extends Model<BDropBoxConfirmDetail> {
     ...
     * 落箱计划ID
     */
    @ApiModelProperty(name = "dropBoxConfirmId", value = "落箱计划ID")
    @TableField(value = "drop_box_confirm_id")
    private String dropBoxConfirmId;
