/**
 * @filename:BRailwayTallyDelResponseBill 2019年08月12日
...
/**
 * @Description: 铁路进口理货作废报文回执表体
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月12日
 * @Version: V1.0
 */
@TableName("b_railway_tally_del_response_bill")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BRailwayTallyDelResponseBill extends Model<BRailwayTallyDelResponseBill> {
