/**
 * @filename:BRailwayTallyBillInfo 2019年08月12日
...
/**
 * @Description: 铁路进口理货申请报文表体
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月12日
 * @Version: V1.0
 */
@TableName("b_railway_tally_bill_info")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BRailwayTallyBillInfo extends Model<BRailwayTallyBillInfo> {
