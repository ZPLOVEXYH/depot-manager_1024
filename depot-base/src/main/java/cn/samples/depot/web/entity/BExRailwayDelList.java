/**
 * @filename:BExRailwayDelList 2019年08月21日
...
/**
 * @Description: 铁路运抵作废报文表体运抵单信息
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月21日
 * @Version: V1.0
 */
@TableName("b_ex_railway_del_list")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BExRailwayDelList extends Model<BExRailwayDelList> {
     ...
     *
     */
    @ApiModelProperty(name = "notes", value = "")
