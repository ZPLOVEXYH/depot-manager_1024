/**
 * @filename:BExRailwayDelConta 2019年08月21日
...
/**
 * @Description: 铁路运抵作废报文表集装箱信息
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月21日
 * @Version: V1.0
 */
@TableName("b_ex_railway_del_conta")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BExRailwayDelConta extends Model<BExRailwayDelConta> {
     ...
     * 表头ID
     */
    @ApiModelProperty(name = "exRailwayReportDelHeadId", value = "表头ID")
    @TableField(value = "ex_railway_report_del_head_id")
    private String exRailwayReportDelHeadId;
    /**
     * 运抵信息ID
     */
    @ApiModelProperty(name = "exRailwayDelListId", value = "运抵信息ID")
    @TableField(value = "ex_railway_del_list_id")
    private String exRailwayDelListId;
    /**
     * 运抵编号
     */
