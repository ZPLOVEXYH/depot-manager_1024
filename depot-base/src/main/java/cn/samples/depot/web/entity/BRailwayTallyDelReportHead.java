/**
 * @filename:BRailwayTallyDelReportHead 2019年08月12日
...
/**
 * @Description: 铁路进口理货作废报文表头
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月12日
 * @Version: V1.0
 */
@TableName("b_railway_tally_del_report_head")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BRailwayTallyDelReportHead extends Model<BRailwayTallyDelReportHead> {
     ...
     *
     */
    @ApiModelProperty(name = "messageIdAdd", value = "")
    @TableField(value = "message_id_add")
    ...
    /**
     * 作废审核状态(01 待申报 02 申报海关 05作废审核通过 06作废审核不通过))
     */
    @ApiModelProperty(name = "auditStatus", value = "作废审核状态(01 待申报 02 申报海关 05作废审核通过 06作废审核不通过))")
