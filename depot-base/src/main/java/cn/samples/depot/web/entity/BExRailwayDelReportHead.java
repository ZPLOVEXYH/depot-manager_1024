/**
 * @filename:BExRailwayDelReportHead 2019年08月21日
...
/**
 * @Description: 铁路运抵作废报文表头
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月21日
 * @Version: V1.0
 */
@TableName("b_ex_railway_del_report_head")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BExRailwayDelReportHead extends Model<BExRailwayDelReportHead> {
     ...
     *
     */
    @ApiModelProperty(name = "messageAddId", value = "")
