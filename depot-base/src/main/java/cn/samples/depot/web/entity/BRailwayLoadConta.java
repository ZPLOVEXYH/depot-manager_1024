/**
 * @filename:BRailwayLoadConta 2019年08月20日
...
/**
 * @Description: 装车记录单申报报文表集装箱信息
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月20日
 * @Version: V1.0
 */
@TableName("b_railway_load_conta")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BRailwayLoadConta extends Model<BRailwayLoadConta> {
