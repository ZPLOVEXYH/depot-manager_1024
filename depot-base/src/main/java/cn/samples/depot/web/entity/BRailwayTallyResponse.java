/**
 * @filename:BRailwayTallyResponse 2019年08月12日
...
/**
 * @Description: 铁路进口理货报文回执
 * @Author: ZhangPeng
 * @CreateDate: 2019年08月12日
 * @Version: V1.0
 */
@TableName("b_railway_tally_response")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@ToString
public class BRailwayTallyResponse extends Model<BRailwayTallyResponse> {
     ...
     * 发出时间
     */
    @ApiModelProperty(name = "sendTime", value = "发出时间")
    @TableField(value = "send_time")
    private Long sendTime;
    /**
     * 接收时间
     */
    @ApiModelProperty(name = "createTime", value = "接收时间")
