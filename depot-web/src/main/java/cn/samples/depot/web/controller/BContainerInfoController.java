...
import static cn.samples.depot.web.controller.BContainerInfoController.API;
...
public class BContainerInfoController {
    ...
    public JsonResult contaInfo(@PathVariable String contaNo) throws Throwable {
        return JsonResult.data(Params.param(M_PAGE, service.lastContaInfo(contaNo, false))
