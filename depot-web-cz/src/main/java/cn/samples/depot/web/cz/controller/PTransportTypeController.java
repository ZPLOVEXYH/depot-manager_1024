...
import cn.samples.depot.web.cz.service.PTransportTypeService;
...
import static cn.samples.depot.web.cz.controller.PTransportTypeController.API;
...
public class PTransportTypeController {
    ...
    static final String API = URL_PRE_STATION + "/PTransportType";
