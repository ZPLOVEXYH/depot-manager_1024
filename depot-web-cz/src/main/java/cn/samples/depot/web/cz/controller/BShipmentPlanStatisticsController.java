...
import static cn.samples.depot.web.cz.controller.BShipmentPlanStatisticsController.API;
 ...
 **/
@Api(tags = "查询统计-发运计划查询")
@RestController
@RequestMapping(value = API)
@Slf4j
public class BShipmentPlanStatisticsController {

    static final String API = URL_PRE_STATION + "/BShipmentPlanStatistics";
