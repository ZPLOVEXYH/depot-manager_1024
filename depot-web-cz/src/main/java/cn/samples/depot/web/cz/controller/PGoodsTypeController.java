...
import cn.samples.depot.web.cz.service.PGoodsTypeService;
...
import static cn.samples.depot.web.cz.controller.PGoodsTypeController.API;
...
public class PGoodsTypeController {
    ...
    static final String API = URL_PRE_STATION + "/PGoodsType";
