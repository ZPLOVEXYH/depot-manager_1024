...
import static cn.samples.depot.web.cz.controller.CDischargesController.API;
...
public class CDischargesController {
    ...
    static final String API = URL_PRE_STATION + "/CDischarges";
...
//    @Cacheable(value = "cDischarges", sync = true)
     ...
     **/
    @GetMapping(SELECT)
    @ApiOperation(value = "下拉列表查询", notes = "下拉列表 ，仅code+name")
